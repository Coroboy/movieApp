...
@Component({
  ...
  template: `
    <div (click)="navigateToMovie()" 
         class="group relative rounded-xl bg-gray-900 shadow-lg transition-all duration-500 cursor-pointer hover:z-50">
      
      <!-- Card Wrapper with Hover Transform -->
      <div class="relative overflow-hidden rounded-xl transition-all duration-500 group-hover:scale-125 group-hover:shadow-[0_30px_80px_rgba(0,0,0,0.8)] group-hover:ring-4 group-hover:ring-yellow-400/60">
